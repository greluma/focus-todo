...
const Home = () => {
    ...
    return (
        <>
            <div className={`grid p-4 min-h-[100vh] bg-center bg-cover transition duration-300 ease-in-out ${showBanner ? 'opacity-90' : ''}`} style={{ backgroundImage: `url(${backgroundImage})` }}>
                ...
                <div className="flex self-center justify-center gap-4 mb-8">
