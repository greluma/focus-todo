...
const Home = () => {
    ...
    function stopFocus() {
        // TODO: que salte un aviso de si esta seguro de reiniciar el pomodoro
        setContinueOrFinish(false)
        dispatch(changeFocusTime(false));
        dispatch(resetTimer())
    }
    ...
    return (
        <div className="min-h-screen p-5 bg-center bg-cover " style={{ backgroundImage: `url(${backgroundImage})` }}>
            ...
            <div className="h-[70vh] grid justify-center content-center grid-rows-5">
                ...
                <div className="row-span-1 m-auto mt-4">
                    ...
                    {continueOrFinish && <div className="flex gap-4"><HomeFocusBtn focusTime={focusTime} icon={<CiPlay1 />} text="Continuar" func={startFocus} /><HomeFocusBtn focusTime={focusTime} icon={<FaStop />} text="Terminar" func={stopFocus} /></div>}
                </div>
            </div>
